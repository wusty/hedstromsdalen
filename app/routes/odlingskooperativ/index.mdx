...
<div style={{ display: "flex", width: "50%", paddingBottom: "1rem", alignItems: "center", maxWidth: "200px" }}>![Bild 1](/img/Hasselfors_garden_logga_CMYK_PNG.png) ![Bild 2](/img/Logo-Leader-Bergslagen-EU-Farg-staende-webb.jpg)</div>